...
int OSC::_wrap_callback(const char *path, const char *types, lo_arg **argv,
 ...
 */
int OSC::realcallback(const char *path, const char *types, lo_arg **argv,
                      int argc) {
  cout << "blah\n";
  return 0;
} // realcallback()